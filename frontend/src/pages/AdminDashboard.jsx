          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 mb-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold">Vendor Reports</h3>
                  <p className="text-white/60 text-sm">Manage vendor reports</p>
                </div>
                <ExternalLink className="w-4 h-4 text-white/40 ml-auto group-hover:text-white/80 transition-colors" />
              </div>
            </Link>
          </div>
