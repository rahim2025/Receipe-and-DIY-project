            ...
            <div className="mb-8">
              ...
              <div className="space-y-6">
                {(currentPost.type === 'recipe' ? currentPost.cookingSteps : currentPost.instructions)?.map((step, index) => (
                  <div key={index} className="glass-panel p-6" style={{ background: 'rgba(0, 0, 0, 0.2)' }}>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <p className="text-white mb-4 text-sm leading-relaxed font-medium readable contrast-on-glass">{step.instruction}</p>
