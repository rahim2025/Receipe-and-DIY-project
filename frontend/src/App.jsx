...
import SimplePostCreate from "./pages/SimplePostCreate"
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/* Protected routes */}
        <Route path="/create" element={authUser ? <SimplePostCreate /> : <Navigate to="/login" />} />
        <Route path="/quick-create" element={authUser ? <QuickCreate /> : <Navigate to="/login" />} />
        <Route path="/edit/:postId" element={authUser ? <SimplePostCreate editMode={true} /> : <Navigate to="/login" />} />
